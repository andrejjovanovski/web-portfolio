...
const Contact = () => {
    return (
        <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
            <form action="https://getform.io/f/navvjmoa" method='POST' className='flex flex-col max-w-[600px] w-full'>
                <div className='pb-8'>
                ...
                <textarea name="message" placeholder='Message..' rows='10' className='p-2 bg-[#ccd6f6]'></textarea>
